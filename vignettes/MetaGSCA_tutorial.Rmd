...
<font size="4"> **Package: MetaGSCA 0.99.0**</font> 
...
mygeneset <- list.files(system.file("extdata", package = "MetaGSCA"),
...
genesetnames <- gsub(paste(system.file("extdata", package = "MetaGSCA"),
                     "/", sep = ""), "", genesetnames)
